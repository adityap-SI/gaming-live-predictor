...
namespace ICC.Predictor.Contracts.Admin
{
    [XmlRoot]
    ...
    public class MatchPlayerStats
    {
        ...
        public long TossWonById { get; set; }
        public string Status { get; set; }
    ...
    public class PlayerStats
    {
        ...
        public int SixesHit { get; set; }
        public int FoursHit { get; set; }
        public int BoundriesHit
        {
            get
            {
