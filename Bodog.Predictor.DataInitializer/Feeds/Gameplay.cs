...
namespace Bodog.Predictor.DataInitializer.Feeds
{
                    ...
                    if (ds.Tables != null && ds.Tables.Count > 0)
                    {
                        if (ds.Tables[0] != null && ds.Tables[0].Rows.Count > 0)
                        {
                            for (int i = 0; i < ds.Tables[0].Rows.Count; i++)
                            {
                                ...
                                fixture.TeamAId = Convert.IsDBNull(ds.Tables[0].Rows[i]["home_teamid"]) ? 0 : Int32.Parse(ds.Tables[0].Rows[i]["home_teamid"].ToString());
                                ...
                                fixture.TeamBId = Convert.IsDBNull(ds.Tables[0].Rows[i]["away_teamid"]) ? 0 : Int32.Parse(ds.Tables[0].Rows[i]["away_teamid"].ToString());
                    ...
                    if (ds.Tables != null && ds.Tables.Count > 0)
                    {
                        if (ds.Tables[0] != null && ds.Tables[0].Rows.Count > 0)
                        {
                            for (int i = 0; i < ds.Tables[0].Rows.Count; i++)
                            {
                                ...
                                question.QuestionStatus = Convert.IsDBNull(ds.Tables[0].Rows[i]["question_status"]) ? 0 : Int32.Parse(ds.Tables[0].Rows[i]["question_status"].ToString());
