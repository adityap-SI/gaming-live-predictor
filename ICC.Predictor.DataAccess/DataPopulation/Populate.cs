...
namespace ICC.Predictor.DataAccess.DataPopulation
{
    public class Populate : BaseDataAccess
    {
        ...
        public int SaveTournament(int[] arr_tour_id, string[] arr_tour_name, string[] arr_tour_display_name, DateTime[] arr_tour_start_date, DateTime[] arr_tour_end_date)
        {
            int retVal = -50;
            ...
            using (NpgsqlConnection connection = new NpgsqlConnection(_ConnectionString))
            {
                try
                {
                    using (NpgsqlCommand mNpgsqlCmd = new NpgsqlCommand(_Schema + spName, connection))
                    {
                        ...
                        retVal = value.Value != null && value.Value.ToString().Trim() != "" ? int.Parse(value.Value.ToString()) : retVal;
                    }
                }
                catch (Exception ex)
                {
        ...
        public int SaveSeries(int[] arr_tour_id, int[] arr_series_id, string[] arr_series_name, string[] arr_series_display_name, DateTime[] arr_series_start_date, DateTime[] arr_series_end_date, List<int> arr_comp_type_id)
        {
            int retVal = -50;
            string spName = string.Empty;
        ...
        public int SaveFixtures(int tournamentId, int seriesId, int[] array_matchid, int[] array_home_teamid, string[] array_series_home_team_name, string[] array_series_home_team_short, int[] array_away_teamid, string[] array_series_away_team_name,
            string[] array_series_away_team_short, DateTime[] array_match_date, string[] array_match_name, string[] array_matchType, string[] array_matchtime_local, string[] array_matchtime_ist, string[] array_matchtime_gmt, string[] array_matchStatus,
        ...
        public int SaveTeams(int tournamentId, int seriesId, int[] array_teamid, string[] array_team_name, string[] array_team_short, string langCode)
        {
            int retVal = -50;
            string spName = string.Empty;
        ...
        public int SavePlayersPerTeam(int optType, string langCode, int tournamentId, int seriesId, int team_id, int[] array_playerid, string[] array_player_name, string[] array_display_name, string[] array_display_skill, List<int> arr_skill_id)
        {
            int retVal = -50;
            string spName = string.Empty;
